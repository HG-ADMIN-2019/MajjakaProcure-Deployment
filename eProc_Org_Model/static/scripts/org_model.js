            ...
            $("#orgErrMsg").removeAttr('hidden')
             ...
             valid = true;
                ...
                if (data.error !== undefined ){
                   ...
                   .removeClass("alert-success")
                   .addClass("alert-danger")
                   .text(data.error || messageConstants.JMSG006);
                }
                else {
...
function on_select_root_node_drop_down(event) {
 ...
 function setNodeType(nodeType){
     ...
     var x = nodeType;
         switch (x) {
             case "CCODE":
                 nodeIcon = "fa fa-building treeIcon text-primary";
                 break;
             case "PORG":
                 nodeIcon = "fa fa-industry treeIcon text-primary";
                 break;
             case "PGRP":
                 nodeIcon = "fa fa-users treeIcon text-primary";
                 break;
             case "PLANT":
                 nodeIcon = "fa fa-building-o treeIcon text-primary";
                 break;
             case "NODE":
                nodeIcon = "fa fa-square treeIcon text-primary";
                 break;
             case "USER":
                 nodeIcon = "fa fa-user treeIcon text-primary";
                 break;
             case "RNODE":
                 nodeIcon = "fa fa-sitemap treeIcon text-primary";
                 break;
         default:
         break;
        }
...
function refreshBD()
{
    document.getElementById("modal_Basic_Detail").style.display = "none";
      ...
      if(attr_level_detail)
      {
         ...
         $.each(attr_level_value, function (i, item) {
            ...
            if (CENTRALIZE_PURCH_LEVEL_FLAG){
                company_detail = '<select disabled><option value="' + item.extended_value+ '" >' + item.extended_value+ '</option></select>'
                }
            else{
            ...
            if (item.attribute_id == "RESP_PROD_CAT"){
                ...
                resp_modify = '<a onclick=clone_resp_table_row() id="' + item.attr_level_guid + '" class="deletepop" ><i class="fa fa-plus text-primary"></i></a>  <a onclick=remove_resp_Row(this) id="' + item.attr_level_guid + '" class="deletepop" ><i class="fa fa-trash text-primary"></i></a>';
                resp_attr_html += '<tr id="resp_attr_tr"><td><input type="number" onkeypress="return event.charCode >= 48" min="0" name="from" value="' + item.low + '" required></td><td><input type="number" onkeypress="return event.charCode >= 48" min="0" name="from" value="' + item.high + '" required></td><td> ' + company_detail + ' </td><td> ' + resp_modify + ' </td></tr>';
                resp_add_new_line = '<tr id="resp_attr_tr"><td><input type="number" onkeypress="return event.charCode >= 48" min="0" name="from" value="' + item.low + '" required></td><td><input type="number" onkeypress="return event.charCode >= 48" min="0" name="from" value="' + item.high + '" required></td><td> ' + cocode_values + ' </td><td> ' + resp_modify + ' </td></tr>';
            }
                ...
                ext_modify = '<a onclick=clone_ext_table_row() id="' + item.attr_level_guid + '" class="deletepop" ><i class="fa fa-plus text-primary"></i></a>  <a onclick=remove_ext_Row(this) id="' + item.attr_level_guid + '" class="deletepop" ><i class="fa fa-trash text-primary"></i></a>';
                ext_attr_html += '<tr id="extend_attr_tr"><td><input type="number" onkeypress="return event.charCode >= 48" min="0" name="from" value="' + item.low + '" required></td><td><input type="number" onkeypress="return event.charCode >= 48" min="0" name="from" value="' + item.high + '" required></td><td> ' + company_detail + ' </td><td> ' + ext_inherit_value + ' </td><td> ' + ext_modify + ' </td></tr>';
                ext_add_new_line = '<tr id="extend_attr_tr"><td><input type="number" onkeypress="return event.charCode >= 48" min="0" name="from" value="' + item.low + '" required></td><td><input type="number" onkeypress="return event.charCode >= 48" min="0" name="from" value="' + item.high + '" required></td><td> ' + cocode_values + ' </td><td> ' + ext_inherit_value + ' </td><td> ' + ext_modify + ' </td></tr>'
            }
            else
            {
                default_value = '';
                ...
                modify = '<a onclick=get_selected_attr_list(this.className) id="' + item.attr_level_guid + '" class="' + item.attribute_id + '" ><i class="fa fa-pencil-square-o text-primary"></i></a>';
        ...
        {
            if(!(ext_attr_html)){
                add_ext_attr = '<tr id="extend_attr_tr"><td><input type="number" name="from" required></td><td><input type="number" name="to" required></td><td> ' + cocode_values + ' </td><td><input disabled type="checkbox" name="inherit" value="inherit"></td><td><a onclick=clone_ext_table_row()><i class="fa fa-plus text-primary"></i></a> </td></tr>';
                ext_add_new_line = '<tr id="extend_attr_tr"><td><input type="number" name="from" required></td><td><input type="number" name="to" required></td><td> ' + cocode_values + ' </td><td><input disabled type="checkbox" name="inherit" value="inherit"></td><td><a onclick=clone_ext_table_row()><i class="fa fa-plus text-primary"></i></a> <a onclick=remove_ext_Row(this) id="ext_new"><i class="fa fa-trash text-primary"></i></a></td></tr>';
        ...
        else
        {
            if(resp_attr_html){
                ...
                add_resp_attr = '<tr><td><input type="number" name="from" required></td><td><input type="number" name="to" required></td><td> ' + cocode_values + ' </td><td><a onclick=clone_resp_table_row() ><i class="fa fa-plus text-primary"></i></a></td></tr>';
                resp_add_new_line = '<tr><td><input type="number" name="from" required></td><td><input type="number" name="to" required></td><td> ' + cocode_values + ' </td><td><a onclick=clone_resp_table_row() ><i class="fa fa-plus text-primary"></i></a> <a onclick=remove_resp_Row(this) ><i class="fa fa-trash text-primary"></i></a></td></tr>';
...
function get_cocode_drop_down(org_comp_dropdown_list,centralize_purch_level_flag){
    ...
    if (centralize_purch_level_flag){
        ...
        cocode_values = '<select>' + cocode_drop_down + '</select>'
      }
      else{
...
function on_click_save_basic_details(){
    ...
    details_edit_input.node_type = node_type
        switch (node_type) {
            case "CCODE":
                ...
                else
                {
                    ...
                    org_name = save_basic_details_ajax_call(details_edit_input);
        ...
        document.getElementById("modal_Basic_Detail").style.display = "block";
