    ...
    def save_assign_unassigned_user(data):
        ...
        for user in user_id_list:
            if node_action == CONST_ASSIGN:
                ...
                result = OrgModel.objects.filter(client=client, del_ind=False, parent_node_guid=parent_node_guid)
            else:
                ...
                result = OrgModel.objects.filter(client=client, parent_node_guid=parent_node_guid)
