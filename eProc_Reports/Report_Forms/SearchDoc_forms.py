...
class DocumentSearchForm(forms.Form):
    ...
    # hide the supplier field as we are not supporting PO currently
    # supplier = forms.CharField(label='Supplier', required=False, widget=forms.TextInput(attrs={'style':'height:26px; width:100%; border:solid 1px #cac6c6;border-radius: 2px;'}))
