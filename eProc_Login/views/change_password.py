    ...
    if request.method == 'POST':
        ...
        if password_change_form.is_valid():
            ...
            if old_password == new_password1:
                return JsonResponse({'error_message': MSG119}, status=400)
            ...
            update_session_auth_hash(request, user)  # Important!
            return JsonResponse({'success_message': MSG120}, status=200)

        else:
            return JsonResponse({'error_message': MSG122}, status=400)
