...
def upload_product_cattegories(request):
    ...
    upload_pcattegories = django_query_instance.django_filter_query(ProductsDetail,
                                                                    {'client': client, 'del_ind': False},
                                                                    None, ['product_id', 'short_desc', 'supplier_id',
    ...
    return render(request, 'ManageContent/upload_product_cattegories.html',
