...
class PoItem(models.Model):
    ...
    tiered_flag = models.BooleanField(default=False, blank=True, null=True, db_column='TIERED_FLAG')  # set this if any dicount
    ...
    manufacturer = models.CharField(db_column='MANUFACTURER', max_length=50, blank=True, null=True, verbose_name='Manufacturer')
