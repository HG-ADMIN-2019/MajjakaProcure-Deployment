...
from eProc_Basic.Utilities.constants.constants import CONST_PO_SPLIT_SUPPLIER, CONST_PO_SPLIT_CURRENCY, \
    ...
    CONST_FT_ITEM_EFORM, CONST_CATALOG_CALLOFF, CONST_ALL, CONST_CATALOG_ITEM_VARIANT
...
class CreatePurchaseOrder:
    def __init__(self, sc_header_instance):
        ...
        self.supplier_id = ''
        self.sc_header_guid_instance = django_query_instance.django_get_query(ScHeader,
                                                                              {'client': global_variables.GLOBAL_CLIENT,
                                                                               'guid': self.sc_header_instance.guid,
                                                                               'del_ind': False})
        self.sc_item_guid = []
                    ...
                    if CONST_PO_SPLIT_CURRENCY in po_split_list:
                        ...
                        if len(currency_list) != 1:
                            ...
                            for currency in currency_list:
                                ...
                                self.create_purchaser_order(sc_item_details, supplier)
    ...
    def create_purchaser_order(self, sc_item_details, supplier_id):
        ...
        # context = create_po_pdf(self.po_document_number)
        ...
        content = 'Dear '+str(self.supplier_name)+',\n Please find attached purchase order.\n\nRegards,\nMajjaka'
        send_to_list.append(get_supplier_email(supplier_id))
        send_po_attachment_email(output, subject, content, send_to_list, self.po_document_number)
    ...
    def create_po_item(self, sc_item_details):
        ...
        for loop_counter, sc_item_detail in enumerate(sc_item_details):
            ...
            po_item_dictionary = {
                ...
                'po_header_guid': self.po_header_guid,
                'client': global_variables.GLOBAL_CLIENT,
                'sc_header_guid': self.sc_header_guid_instance,
