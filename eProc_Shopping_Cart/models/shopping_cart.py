...
class DBQueries():
    def get_hdr_data_by_objid(self, obj, objid, client):
        return obj.objects.filter(doc_number=objid, client=client, del_ind=False).order_by('doc_number')
    ...
    # End of MEP:19
    def get_hdr_data_by_fields(self, client, obj, supp_query, creator_query, requester_query, **kwargs):
...
class ScItem(models.Model):
    ...
    po_doc_num = models.CharField(db_column='po_doc_num', max_length=10, blank=True, null=True, verbose_name='PO Doc Number')
    ...
    offcatalog = models.BooleanField(db_column='OFFCATALOG', blank=True, null=True)
    supp_type = models.CharField(db_column='SUPP_TYPE', max_length=35, blank=True, null=True, verbose_name='Supplier Type')
    ...
    cash_disc2 = models.PositiveIntegerField(db_column='CASH_DISC2', blank=True, null=True,
                                             verbose_name='Discount % value to be filled (from eform table - qty based discount)')
    supplier_note_existence_flag = models.BooleanField(db_column='SUPPLIER_NOTE_EXISTENCE_FLAG', default=False, blank=True, null=True,
                                                       verbose_name='Supplier note existence flag')
    internal_note_existence_flag = models.BooleanField(db_column='INTERNAL_NOTE_EXISTENCE_FLAG', default=False, blank=True, null=True,
                                                       verbose_name='Internal note existence flag')
    attachment_existence_flag = models.BooleanField(db_column='ATTACHMENT_EXISTENCE_FLAG', default=False, blank=True, null=True,
                                                    verbose_name='Attachment existence flag')
    accounting_change_flag = models.BooleanField(db_column='ACCOUNTING_CHANGE_FLAG', default=False, blank=True, null=True,
...
class ScAccounting(models.Model):
    ...
    generic_acc_str = models.CharField(db_column='GENERIC_ACC_STR', max_length=64, blank=True, null=True, verbose_name='Generic Acc Ass')
