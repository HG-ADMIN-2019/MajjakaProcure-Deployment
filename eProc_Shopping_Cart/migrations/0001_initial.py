    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.DecimalField(blank=True, db_column='PRICE', decimal_places=2, max_digits=13, null=True, verbose_name='Price')),
                ('currency', models.CharField(db_column='CURRENCY', max_length=5, null=True, verbose_name='Currency')),
                ('price_unit', models.CharField(blank=True, db_column='PRICE_UNIT', max_length=5, null=True, verbose_name='Price Unit')),
                ('unit', models.CharField(db_column='UNIT', max_length=30, verbose_name='Unit')),
                ('gross_price', models.DecimalField(db_column='GROSS_PRICE', decimal_places=2, max_digits=13, null=True, verbose_name='Gross Price')),
                ...
                ('doc_type', models.CharField(blank=True, db_column='DOC_TYPE', max_length=10, null=True)),
                ...
                ('lead_time', models.CharField(blank=True, db_column='LEAD_TIME', max_length=5, null=True)),
                ('price_origin', models.CharField(blank=True, db_column='PRICE_ORIGIN', max_length=1, null=True)),
                ('value', models.PositiveIntegerField(blank=True, db_column='VALUE', null=True)),
                ('final_inv', models.CharField(blank=True, db_column='FINAL_INV', max_length=1, null=True)),
                ('val_cf_f', models.PositiveIntegerField(blank=True, db_column='VAL_CF_F', null=True)),
                ('val_cf', models.PositiveIntegerField(blank=True, db_column='VAL_CF', null=True)),
                ...
                ('supplier_name', models.CharField(blank=True, db_column='SUPPLIER_NAME', max_length=40, null=True)),
                ...
                ('service_item', models.BooleanField(db_column='SERVICE_ITEM', default=False)),
