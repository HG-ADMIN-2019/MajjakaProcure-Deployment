...
const display_fields_from_array = () => {
    ...
    $.each(eform_configured, function (index, value) {
        ...
        if (field_data_type == 'dropdown') {
            ...
            div_content = '<div class="form-row eform-field-wrapper" id="array_index-' + index + '"><div class="form-group col-md-11"> <label  for="' + field_name + '">' + field_name + '</label><span id="span_' + field_name + '"></span> <select class="form-control toggle_mode">' + options + '</select></div> <div class="col-auto eform-field-btn-wrapper"> <button id="button_id-' + index + '" type="button" onclick="remove_element(this.id)"  class="btn btn-outline-danger btn-sm btn-delete toggle_mode" disabled><i class="far fa-trash-alt"></i></button></div> </div>'
        }
        else if (field_data_type == 'checkbox') {
            div_content = '<div class="form-row eform-field-wrapper" id="array_index-' + index + '"> <div class="form-group col-md-11"> <input class="toggle_mode" type="' + field_data_type + '"> <label  for="' + field_name + '">' + field_name + '</label><span id="span_' + field_name + '"></span> </div> <div class="col-auto eform-field-btn-wrapper"> <button id="' + field_name + '-' + index + '" type="button" onclick="remove_element(this.id)"  class="btn btn-outline-danger btn-sm btn-delete toggle_mode" disabled><i class="far fa-trash-alt"></i></button></div> </div>'
        }
        else if (field_data_type == 'textarea') {
            div_content = '<div class="form-row eform-field-wrapper" id="array_index-' + index + '"> <div class="form-group col-md-11"> <label  for="' + field_name + '">' + field_name + '</label><span id="span_' + field_name + '"></span> <textarea class="form-control toggle_mode"></textarea> </div> <div class="col-auto eform-field-btn-wrapper"> <button id="' + field_name + '-' + index + '" type="button" onclick="remove_element(this.id)"  class="btn btn-outline-danger btn-sm btn-delete toggle_mode" disabled><i class="far fa-trash-alt"></i></button></div> </div>'
        }
            ...
            if(date_type == 'datetime_value_on'){
                div_content = '<div class="form-row eform-field-wrapper" id="array_index-' + index + '"> <div class="form-group col-md-11"> <label  for="' + field_name + '">' + field_name + '</label><span id="span_' + field_name + '"></span> <input class="form-control toggle_mode" type="' + field_data_type + '"> </div> <div class="col-auto eform-field-btn-wrapper"> <button id="' + field_name + '-' + index + '" type="button" onclick="remove_element(this.id)"  class="btn btn-outline-danger btn-sm btn-delete toggle_mode" disabled><i class="far fa-trash-alt"></i></button></div> </div>'
            } else if(date_type == 'datetime_value_timeframe') {
                div_content = '<div class="form-row eform-field-wrapper" id="array_index-' + index + '"> <div class="form-group col-md-11"> <label for="">Form Date</label><span id="span_' + field_name + '"></span> <input class="form-control toggle_mode" type="date"> <label for="">To Date</label><span id="span_' + field_name + '"></span> <input class="form-control toggle_mode" type="date"> </div> <div class="col-auto eform-field-btn-wrapper"> <button id="' + field_name + '-' + index + '" type="button" onclick="remove_element(this.id)"  class="btn btn-outline-danger btn-sm btn-delete toggle_mode" disabled><i class="far fa-trash-alt"></i></button></div> </div>'
            }
        }
        else {
            div_content = '<div class="form-row eform-field-wrapper" id="array_index-' + index + '"> <div class="form-group col-md-11"> <label  for="' + field_name + '">' + field_name + '</label><span id="span_' + field_name + '"></span> <input class="form-control toggle_mode" type="' + field_data_type + '"></div> <div class="col-auto eform-field-btn-wrapper"> <button id="' + field_name + '-' + index + '" type="button" onclick="remove_element(this.id)"  class="btn btn-outline-danger btn-sm btn-delete toggle_mode" disabled><i class="far fa-trash-alt"></i></button></div> </div>'
