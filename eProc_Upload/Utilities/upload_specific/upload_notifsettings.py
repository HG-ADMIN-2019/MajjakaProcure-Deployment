    ...
    try:
        ...
        if Test_mode == 'on':
            ...
            for column in csv.reader ( timezone, delimiter=',', quotechar='"' ):
                ...
                if (del_ind_field == '0') and (NotifSettings.objects.filter ( variant_name=column[1] ,client=client ).exists ()):
                ...
                elif (del_ind_field == '0') and (not (NotifSettings.objects.filter ( variant_name=column[1] ,client=client ).exists ())):
                    if column[0] in Test_notifset_number_list:
                        Test_Duplicate_Count_notifset = Test_Duplicate_Count_notifset + 1
                        Test_notifset_errmsg_duplicate = MSG094
                    else:
                ...
                if (del_ind_field == '1') and (NotifSettings.objects.filter ( variant_name=column[1] ,client=client ).exists ()):
            ...
            for column in csv.reader ( timezone, delimiter=',', quotechar='"' ):
                ...
                if (del_ind_field == '0') and (not (NotifSettings.objects.filter ( variant_name=column[1] ,client=client ).exists ())):
                ...
                elif (del_ind_field == '0') and (NotifSettings.objects.filter ( variant_name=column[1] ,client=client ).exists ()):
                ...
                elif (del_ind_field == '1') and (not (NotifSettings.objects.filter ( variant_name=column[1] ,client=client ).exists ())):
