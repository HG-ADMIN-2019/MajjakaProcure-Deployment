...
class CompareTableHeader:
    ...
    def basic_header_condition(self):
        ...
        err_msg = ''
        exclude_list = ['CREATED_BY','CREATED_AT','CHANGED_BY','CHANGED_AT','created_by','created_at','changed_by','changed_at','GUID','SOURCE_SYSTEM','client_id','CLIENT_ID','source_system']
        field_details = []
