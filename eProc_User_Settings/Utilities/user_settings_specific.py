...
def get_org_attr_list():
    ...
    if global_variables.GLOBAL_LOGIN_USER_OBJ_ID:
        ...
        if not default_acc_list:
            error_message_list.append(MSG115 + "Account Assignment Category")
        if acc_drop_down_list:
            ...
            error_message_list.append(MSG116 + "Account Assignment Category")
        ...
        if not default_cocode_list:
            error_message_list.append(MSG115 + 'Company Code')
        if default_cocode_list:
            ...
            if not default_cc_list:
                error_message_list.append(MSG115 + "Cost Center")
            if default_cocode_list:
                if cc_drop_down_list:
                    ...
                    error_message_list.append(MSG116 + "Cost Center")
            ...
            if default_wbs_list:
                error_message_list.append(MSG115 + "WBS element")
            if default_cocode_list:
                if wbs_drop_down_list:
                    ...
                    error_message_list.append(MSG116 + "WBS element")
            ...
            if not default_internal_order_list:
                error_message_list.append(MSG115 + "Internal order")
            if default_cocode_list:
                if internal_order_drop_down_list:
                    ...
                    error_message_list.append(MSG116 + "Internal order")
            ...
            if default_cocode_list:
                if asset_drop_down_list:
                    ...
                    error_message_list.append(MSG116 + "Asset")
        else:
            cc_drop_down_list = []
            wbs_drop_down_list = []
            internal_order_drop_down_list = []
        ...
        if not default_doc_type_list:
            error_message_list.append(MSG115 + "Document type")
        ...
        if doc_type_drop_down_list:
            ...
            if doc_search_val_desc:
                ...
                error_message_list.append(MSG117 + "Document type")
        else:
            error_message_list.append(MSG116 + "Document type")
        ...
        if not default_delivery_addr_list:
            error_message_list.append(MSG115 + "Delivery Address")
        if delivery_addr_drop_down_list:
            ...
            if not delivery_addr_drop_down_list:
                error_message_list.append(MSG117 + "Delivery Address")
        else:
            error_message_list.append(MSG116 + "Delivery Address")
        ...
        if not default_inv_addr_list:
            error_message_list.append(MSG115 + "Invoice Address")
        if inv_addr_drop_down_list:
            ...
            if not inv_addr_drop_down_list:
                error_message_list.append(MSG117 + " Invoice Address")
        else:
            error_message_list.append(MSG116 + " Invoice Address")
        ...
        error_message_list.append(MSG118)
