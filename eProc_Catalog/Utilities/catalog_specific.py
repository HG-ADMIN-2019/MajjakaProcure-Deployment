...
def get_searched_prod_detail(selected_catalog, search_type, search_id):
    ...
    form_detail = django_query_instance.django_filter_only_query(FreeTextForm, {
        'client': global_variables.GLOBAL_CLIENT, 'form_id__in': global_variables.GLOBAL_FORM_ID_LIST
    }).values()
