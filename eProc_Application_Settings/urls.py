...
urlpatterns = [
    ...
    path('fav_number_ranges/', views.number_range_favourite_cart,
         name='number_range_favourite_cart'),
    ...
    path('org_attributes_level', views.org_attributes_level, name='org_attributes_level'),
