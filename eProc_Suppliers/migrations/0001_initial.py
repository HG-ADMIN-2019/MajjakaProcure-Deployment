    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gr_inv_vrf', models.BooleanField(db_column='GR_INVOICE_VERIFICATION', default=False)),
                ('inv_conf_exp', models.BooleanField(db_column='INVOICE_CONFIRMATION_EXPECTED', default=False)),
                ('gr_conf_exp', models.BooleanField(db_column='GR_CONFIRMATION_EXPECTED', default=False)),
                ('po_resp', models.BooleanField(db_column='PO_RESPONSE', default=False)),
