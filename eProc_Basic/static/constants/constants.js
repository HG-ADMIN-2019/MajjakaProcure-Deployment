const uiConstants = {
    ...
    CONST_HEADER_DATA_DETGL: ['PROD_CAT_ID','FROM_VALUE','TO_VALUE','GL_ACCOUNT','GL_ACC_DEFAULT','COMPANY_ID','ACCOUNT_ASSIGN_CAT','CURRENCY_ID','del_ind'],
    ...
    CONST_HEADER_DATA_ADDRESS_TYPE:['ADDRESS NUMBER', 'ADDRESS TYPE','COMPANY_ID','del_ind'],
    CONST_HEADER_DATA_ORGCOMPANIES:['OBJECT_ID', 'NAME1', 'NAME2','COMPANY_ID','del_ind'],
    CONST_HEADER_DATA_WFACCOUNTING:['ACC_VALUE', 'COMPANY_ID', 'APP_USERNAME',
                                   'SUP_COMPANY_ID', 'SUP_ACC_VALUE', 'WORKFLOW_ACC_SOURCE_SYSTEM',
                                   'ACCOUNT_ASSIGN_CAT', 'CURRENCY_ID', 'SUP_ACCOUNT_ASSIGN_CAT', 'DEL_IND'],
