...
urlpatterns = [
    ...
    path('application_monitoring', views.application_monitoring, name='application_monitoring'),
    path('email_user_monitoring', views.email_user_monitoring, name='email_user_monitoring'),
